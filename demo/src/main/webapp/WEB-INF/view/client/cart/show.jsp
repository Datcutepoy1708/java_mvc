                    ...
                    <tr>
                      <th scope="row">
                        <div class="d-flex align-items-center">
                          <img src="/images/image/${cartDetail.product.image}" class="img-fluid me-5 rounded-circle"
                      ...
                      <td>
                        <p class="mb-0 mt-4" data-cart-detail-id="${cartDetail.id}">
                          <fmt:formatNumber value="${cartDetail.product.price * cartDetail.quantity}" type="number" />
                        </p>
                        đ
                      </td>
                      <td>
