                ...
                <div class="col-md-6 col-12 mx-auto">
                  ...
                  >
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" value="${order.user.fullname}" disabled />
                    </div>
                    <div class="mb-3">
                      <label class="form-label">Tổng tiền:</label>
                      <input type="text" class="form-control" value="${order.totalPrice} đ" disabled />
                    </div>
                    <div class="mb-3">
                      <label class="form-label">Trạng thái:</label>
                      <input type="text" class="form-control" value="${order.status}" disabled />
                    </div>
                    <a href="/admin/order" class="btn btn-secondary me-2">Back</a>
